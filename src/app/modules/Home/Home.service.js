...
const CONTEST_RULES = [
    [
        "You can try your luck as much as you want for each question. And if you are tired, come again after sometime.",
        "We will wait for you at the same level."
    ],
    ...
    [
        "All answers should be submitted in lowercase. Format includes no spaces, no capital cases and no special characters.",
        "Eg. Windows 10 => windows10, ravi’s mother -> ravismother, 30/05/1997 -> 30051997 www.google.com => wwwgooglecom"
    ],
    ...
    [
        "Sometimes you might have to try all permutations of an expected answer to get the correct answer.",
        "Ex sachin, sachintendulkar, sachinrameshtendulkar"
    ],
